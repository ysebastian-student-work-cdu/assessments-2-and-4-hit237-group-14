...
# below codes (home def function) is additional codes to achieve complexity category
# this is using Django models (models.py) to define "Profile" and "Introduction" model and store
# the team members profile and website introduction in a database (admin.py)
# created by Putu
